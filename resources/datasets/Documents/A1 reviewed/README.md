...
days = range(0, 421)  # Day 0 to day 420
...
- **Sampling**: Daily measurements (day 0, day 2, ..., day 420)
- **Time reference**: Day 0 corresponds to explosion start
- **Flux units**: Arbitrary units (consistent within each model)

### Column Structure
**light_curves.parquet**:
- Columns: `day_0`, `day_2`, `day_3`, ..., `day_420`
...
### Recommended Usage
- **Suitable for**: ML Algorithm development with daily cadence observations, method testing for survey-like data
