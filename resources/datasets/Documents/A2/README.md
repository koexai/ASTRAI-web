...
- **light_curves.parquet**: Contains 10,000 synthetic supernova light curves, each with 1,601 temporal samples
- **params.parquet**: Corresponding physical parameters for each light curve (7 parameters per supernova)
...
- Both files have the same number of rows (≈10,000)
