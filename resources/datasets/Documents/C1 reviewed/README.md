...
├── LICENSE_CC_BY_40.md                     # Detailed generation methodology
├── dictionary.csv                          # Fomrats of dataset
...
- **Model Architecture**: DDPM with Custom UNet with parameter conditioning
...
- **Model Validation**: Denoising Diffusion Probabilistic Model trained with monitored convergence on validation set
...
```
Naso, L. et al. (2025). Synthetic Supernova Light Curves Dataset (Version 1.0.0). 
...
- **Project**: ASTRAI (Koexai S.r.l.) [astrai.koexai.com]
