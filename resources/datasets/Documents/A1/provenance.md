...
- **Column Structure**: 421 columns named `day_1` through `day_421`
...
- **Sampling Coverage**: Even coverage across 4-dimensional parameter space
- **Range Justification**: Parameter bounds based on supernova observations and theory
- **Sample Size**: Sufficient density for machine learning applications
- **Correlation Analysis**: Verified minimal unintended parameter correlations

### Light Curve Properties
- **Peak Times**: Range from ~10-50 days depending on progenitor properties
- **Peak Luminosities**: Span typical Type II supernova brightness range
- **Decline Rates**: Cover observed range of supernova decline timescales
- **Duration**: 421-day coverage captures both photospheric and nebular phases

## 5. Known Model Limitations and Assumptions

### Semi-Analytical Approximations
- **Spherical Symmetry**: All explosions assumed spherically symmetric
- **Homogeneous Mixing**: Uniform distribution of radioactive material
- **LTE Assumptions**: Local thermodynamic equilibrium in opacity calculations
- **Gray Treatment**: Simplified frequency-averaged opacity

### Temporal Limitations
- **Daily Sampling**: Sub-daily variability not captured
- **Early Times**: First few days may be less accurate due to shock breakout complexity
- **Very Late Times**: Beyond ~300 days, nebular approximations become less reliable
- **Discrete Sampling**: Smooth interpolation between daily points

### Physical Scope
- **Single Type**: Models represent Type II-like supernovae only
- **No Environment**: Circumstellar interaction not included in this simplified version
- **Fixed Composition**: Metallicity and detailed composition held constant
- **No Asymmetries**: Explosion and ejecta assumed perfectly spherical

## 6. Software and Dependencies
